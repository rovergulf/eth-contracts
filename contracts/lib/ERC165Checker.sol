...
interface IIDChecker {
    function isERC20(address nftAddress) external view returns (bool);

    function isERC721(address nftAddress) external view returns (bool);

    function isERC777(address nftAddress) external view returns (bool);
...
contract InterfaceChecker is IIDChecker, IERC165 {
    ...
    function isERC20(address nftAddress) external view override returns (bool) {
        return nftAddress.supportsInterface(IID_IERC20);
    }

    function isERC777(address nftAddress) external view override returns (bool) {
        return nftAddress.supportsInterface(IID_IERC777);
    }
